...
Created with py5: a new version of Processing for Python 3.8+
...
class Aquatic:
    ...
    def drawAquatic(self):
        ...
        for char in chars:
            ...
            play = self.s/2
            text_size(random(play/3, play/1.5))
...
def spawn():
    ...
    aquatic = Aquatic(width/2, height/2, random(80, 130),
                      fillcolor, bubble=True, bgcolor='#FFF')
    aquatic.drawAquatic() 
